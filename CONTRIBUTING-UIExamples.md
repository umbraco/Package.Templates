...
The item template and source files for the package can be found as an [item template within this repo](https://github.com/umbraco/Package.Templates/tree/dev/ui-examples/ItemTemplates/UIExamples/App_Plugins/uiexamples).
TODO swap branch in link above to master!
...
To add a new content app tab you need to first add a new folder in the [root folder](https://github.com/umbraco/Package.Templates/tree/dev/ui-examples/ItemTemplates/UIExamples/App_Plugins/uiexamples) named after your section, then add a view that you can reference in the [uiexamples.section.controller.js file](https://github.com/umbraco/Package.Templates/blob/dev/ui-examples/ItemTemplates/UIExamples/App_Plugins/uiexamples/uiexamples.section.controller.js)
